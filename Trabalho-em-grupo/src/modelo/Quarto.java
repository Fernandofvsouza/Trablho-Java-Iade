...
public class Quarto {
    ...
    //Método para listar quartos ocupados, incluindo verificação se há quartos ocupados
    //Falta adicionar dados de ocupação do quarto, como nome do hóspede e datas de check-in e check-out
